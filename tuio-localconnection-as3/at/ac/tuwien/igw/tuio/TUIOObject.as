		...
		internal function notifyCreated():void {
			if(this.tuioObject){
				try{
					...
					this.tuioObject.dispatchEvent(new TouchEvent(TouchEvent.MOUSE_DOWN, true, false, this.x, this.y, this.localPoint.x, this.localPoint.y, 0, 0, this.tuioObject, false,false,false, true, 0,this.tuioType, this,id, this.sID, this.angle));									
					this.tuioObject.dispatchEvent(new TouchEvent(TouchEvent.MOUSE_OVER, true, false, this.x, this.y, this.localPoint.x, this.localPoint.y, 0, 0, this.tuioObject, false,false,false, true, 0,this.tuioType, this,id, this.sID, this.angle));																	
